...
export default function PatientListReceptionist() {
    ...
    return <>
        ...
        <table className="table table-striped mt-2">
            ...
            <tbody>
                {patientList.filter((patient) => patient.receptionist === id).map((patient, index) =>
                    <tr key={index}>
                        <td>{index + 1}</td>
                        <td>{patient._id}</td>
                        ...
                        <td>
                            ...
                            <button className="btn btn-outline-danger ml-2" onClick={() => deletePatient(patient._id)} >Delete</button></td>
                    </tr>)}
            </tbody>
        </table>
    </>
